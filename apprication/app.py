from apprication.tabelog_data_collect import Tabelog_Data_Collect
from apprication.data_maked import DataMaker
from apprication.analysts import Analysts
from apprication.mapping import Mapping
